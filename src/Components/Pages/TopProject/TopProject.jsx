            ...
            <div className="mt-6 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                <div className="w-72 h-60 overflow-hidden bg-red-400 test parent-overly mx-auto">
                    ...
                    <div className="overly">
                        ...
                        <Link to='/view-project/' className="flex items-center justify-center gap-2 hover:text-white hover:font-bold">View Project <FaArrowRight className="arrow"></FaArrowRight></Link>
                    </div>
                </div>
